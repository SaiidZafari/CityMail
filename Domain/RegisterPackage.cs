...
namespace City_Mail.Domain
{
    ...
    {
        /// <summary>
        /// This metohod used for at read infor mation from Datasources,
        /// due to ID is autogenarated and we dont want to make any changes 
        /// </summary>
        /// <param name="iD"></param>
        /// <param name="sender"></param>
        /// <param name="destination"></param>
        //public RegisterPackage(int iD, string sender, string destination)
        //{
        //    ID = iD;
        //    Sender = sender;
        ...
        /// <summary>
        /// This method used for input when ID is Autogenerated
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="destination"></param>
        //public RegisterPackage(string sender, string destination)
        //{
        //    ID = AutoGeneratID();
        //    Sender = sender;
        //    Destination = destination;
        ...
        //public RegisterPackage(int iD, string sender, string destination, string status)
        //{
        //    ID = iD;
        //    Sender = sender;
        //    Destination = destination;
